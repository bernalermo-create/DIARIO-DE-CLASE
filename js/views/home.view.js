...
var HomeView = (function () {
  ...
  return {
    async render(container) {
          ...
          '<div class="card" style="margin-bottom:14px">' +
            ...
            todayBlocks.map(function (b) {
              ...
              return '<div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--border)">' +
                ...
                (g ? '<button class="btn btn-sm btn-secondary" data-att-gid="' + b.groupId + '" style="margin-right:6px">✅ Asistencia</button>' : '') +
      ...
      container.querySelectorAll('[data-att-gid]').forEach(function (btn) {
        btn.onclick = function (e) {
          e.stopPropagation();
          Router.go('grupo', { groupId: btn.dataset.attGid, quickAttendance: true });
        };
      });
    },
